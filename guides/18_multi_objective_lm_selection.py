...
[Guide 17](https://synalinks.github.io/synalinks/guides/Hyperparameter%20Search/) introduced hyperparameter search and tuned three knobs of
...
threshold-based reward via `RewardFunctionWrapper`, [Guide 13](https://synalinks.github.io/synalinks/guides/Rewards/)).
...
([Guide 7](https://synalinks.github.io/synalinks/guides/Knowledge%20Base/)); the bugs it prevents are unpleasant in exactly the
...
Three helpers from `synalinks.datasets` (introduced in [Guide 11](https://synalinks.github.io/synalinks/guides/Datasets/))
...
The tuner construction is almost the same as in [Guide 17](https://synalinks.github.io/synalinks/guides/Hyperparameter%20Search/), with
two differences:
...
def load_emotion_split(split: str, limit: int):
    ...
    see [Guide 11](https://synalinks.github.io/synalinks/guides/Datasets/).
    """
