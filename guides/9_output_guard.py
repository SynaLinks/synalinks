...
[Guide 8](https://synalinks.github.io/synalinks/guides/Input%20Guard/) put a guard at the *entrance* of the program. This guide
...
original. Just like [Guide 8](https://synalinks.github.io/synalinks/guides/Input%20Guard/), we get this `if`/`else` *out of the
