...
| | Constrained (Guide 26) | Free-form (this guide) |
|---|---|---|
...
Compared with Guide 26, there is no `Union` of concrete types and no
...
materializes whatever arrives**. In Guide 26 the two happened to line up
...
same `EmbedKnowledge` → `UpdateKnowledge` pair from Guide 26:
...
The same multi-stage strategies and orphan-node reasoning from Guide 26
