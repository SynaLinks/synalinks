...
few-shot examples or eight? In [Guide 15](https://synalinks.github.io/synalinks/guides/Training/) we picked sensible defaults
...
the hood, so the arguments will look very familiar from [Guide 15](https://synalinks.github.io/synalinks/guides/Training/):
...
- The contract you write is **one `async` function**,
  ...
  returns a *compiled* `Program` (as in [Guide 15](https://synalinks.github.io/synalinks/guides/Training/)).
