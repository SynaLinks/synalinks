...
- **손쉬운 모델 전환** : `synalinks.set_default_language_model(...)`로 기본값을 한 번만 설정하거나 문자열 식별자를 전달하면, [LiteLLM](https://docs.litellm.ai/docs/)을 통해 Ollama, vLLM, OpenAI, Azure, Anthropic, Mistral, Groq, Gemini, xAI, Cohere, DeepSeek, Together AI, OpenRouter, AWS Bedrock, Doubleword, Mirai 사이를 자유롭게 전환할 수 있습니다. 비용/품질 기준으로 최적의 모델을 고르는 [다목적 모델 선택](https://synalinks.github.io/synalinks/guides/Multi-Objective%20LM%20Selection/)도 포함됩니다.
