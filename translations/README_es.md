...
- **Cambio de modelo sin esfuerzo**: define un valor por defecto una sola vez con `synalinks.set_default_language_model(...)` o pasa un identificador de cadena, y alterna entre Ollama, vLLM, OpenAI, Azure, Anthropic, Mistral, Groq, Gemini, xAI, Cohere, DeepSeek, Together AI, OpenRouter, AWS Bedrock, Doubleword y Mirai mediante [LiteLLM](https://docs.litellm.ai/docs/), incluyendo [selección multiobjetivo de modelos](https://synalinks.github.io/synalinks/guides/Multi-Objective%20LM%20Selection/) para elegir el mejor modelo según coste/calidad.
