...
- **Müheloser Modellwechsel**: Setze einmal einen Default mit `synalinks.set_default_language_model(...)` oder übergib einen String-Identifier und wechsle über [LiteLLM](https://docs.litellm.ai/docs/) zwischen Ollama, vLLM, OpenAI, Azure, Anthropic, Mistral, Groq, Gemini, xAI, Cohere, DeepSeek, Together AI, OpenRouter, AWS Bedrock, Doubleword und Mirai, inklusive [multikriterieller Modellauswahl](https://synalinks.github.io/synalinks/guides/Multi-Objective%20LM%20Selection/), um das beste Modell für Kosten/Qualität zu finden.
