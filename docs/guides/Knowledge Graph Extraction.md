<!-- colab-badge:start -->
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/SynaLinks/synalinks/blob/main/notebooks/guides/knowledge_graph_extraction.ipynb)
<!-- colab-badge:end -->

::: guides.27_knowledge_graph_extraction
...
??? example "Full run log — `guides/27_knowledge_graph_extraction.log`"

    ```text
    --8<-- "guides/27_knowledge_graph_extraction.log"
    ```
