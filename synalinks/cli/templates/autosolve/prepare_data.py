...
When you move to *your own* task, put the data loading here and have
`evaluate.py` import it instead, e.g.:
...
# =============================================================================
# Synalinks ships ready-to-use benchmarks under `synalinks.datasets.*`, each
