...
class EntityFullTextSearchInput(DataModel):
...
@synalinks_export(
    [
        "synalinks.modules.EntityFullTextSearch",
        "synalinks.EntityFullTextSearch",
    ]
)
class EntityFullTextSearch(Module):
        ...
        *,
        ...
        if self.label is None:
            gen_target = {
                "schema": concat_infer_fields(
                    EntityFullTextSearchInput.get_schema(),
                    [
                        (
                            "entity_label",
            ...
            gen_target = {"data_model": EntityFullTextSearchInput}
        ...
        self.query_generator = Generator(
            **gen_target,
            ...
            return_inputs=False,
            name="entity_fulltext_search_query_generator_" + self.name,
        )
    ...
    async def call(self, inputs, training=False):
        ...
        rows = await self.knowledge_base.entity_fulltext_search(
            queries,
            label=label,
            k=self.k,
